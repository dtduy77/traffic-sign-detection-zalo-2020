...
```
*Results are saved to `result_side_by_side/`.*

### 🔍 Performance Observations
*   **Strong Detection**: The model successfully detects and classifies the vast majority of traffic signs with high confidence.
